...
<%
	...
	//设定信箱类型
	String boxType = McSystemConstants.MESSAGE_DRAFT_BOX;
%>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript">
	...
	<body>
							...
							<table id="messageList" class="table table-bordered table-hover">
								<thead>
									<tr>
										...
										<th width="25%" data-field="messageContent" data-render="messageShowLink">内容</th>
		...
		<script type="text/javascript" src="<ui:context/>jsp/mc/message/draftbox/js/msg_draftbox_query.js"></script>
